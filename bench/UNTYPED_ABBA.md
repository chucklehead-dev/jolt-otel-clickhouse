...
Candidate is benchmark wrapper `b492e8811e575f156e7b5c1ae383ba81e1a3bdd3`.
Both arms resolve the same source and dependencies; `BENCH_ARM` selects whether
the public export uses the prototype wrapper. OTel is fixed at merged
...
path; candidate eligibility and a nonnil encoder are mandatory. Every batch must
